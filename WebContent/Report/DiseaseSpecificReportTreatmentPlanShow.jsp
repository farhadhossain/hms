...
String[] treatmentId = request.getParameterValues("treatmentId");

ReportService reportServ = new ReportService();
ArrayList<ReportDTO> reportDTOList = reportServ.DiseaseSpecificReport(diseaseID, treatmentId, MyConfig.diseaseTreatmentPlan);
