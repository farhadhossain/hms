            	...
            	<div class="col-lg-12">
                 <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Report Based On Treatment Plan</h5>
                    </div><!--/./ibox-title-->
					
                    <div class="ibox-content">
						
						<form action="DiseaseSpecificReportTreatmentPlanShow.jsp">
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select onchange="changeTreatmentPlan(this.value)" name="diseaseID" id="diseaseID" class="form-control m-b" >
				                    		<%
				                    		int firstDisease=-1;
									...
									<%if(disTreatmentPlanList.size()>0){%>
										...
										<div class="col-sm-4">
											<table class="table" style="font-size: 13px;">
												<%=MyUtilityForReport.generateHTMLWithOutTextBox(disTreatmentPlanList, disTreatmentPlanParentByChild, "treatmentId")%>
											</table>
										</div>
									<%}%>
								</div>
