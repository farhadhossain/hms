                			...
                			<div class="ibox float-e-margins">
                    			<div class="ibox-title">
                   				...
                   				<div class="ibox-content">
									<html:form action="/UpdatePatientGeneralSurveyAction">
                              							...
                              							<div class="panel-body">
															<div class="table-responsive">
                                 								<table class="table" style="font-size: 13px;">
																	<%=MyUtility.generateHTML(patGeneralAssessmentOfIllnessList, new HashMap<Integer, String>(), "infoId", patCurInfoDTO.patInfoId, patCurInfoDTO)%>
										                         </table>
									                         </div><!--/./form-group--> 
                           								 </div>
                           							 </div>
						                         	...
						                         	<div class="panel-heading" role="tab" id="headingTwo">
						                           	...
						                           	<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
					                             		<div class="panel-body">
						                        			<div class="table-responsive">
						                                		<table class="table" style="font-size: 13px;">
						                                			<%=MyUtility.generateHTML(patMentalStateAndIntelligenceList, new HashMap<Integer, String>(), "infoId", patCurInfoDTO.patInfoId, patCurInfoDTO)%>
						                                		</table>
						                           			</div>
														</div>
					                           		</div>
												 ...
												 <div class="panel panel-default">
                            						...
                            						<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                              							<div class="panel-body">
															<div class="table-responsive">
                                 								<table class="table" style="font-size: 13px;">
																	<%=MyUtility.generateHTML(patMentalStateList, new HashMap<Integer, String>(), "infoId", patCurInfoDTO.patInfoId, patCurInfoDTO)%>
										                         </table>
									                         </div><!--/./form-group--> 
                           								 </div>
                           							 </div>
												...
												<div class="panel panel-default">
                            						...
                            						<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                              							<div class="panel-body">
															<div class="table-responsive">
                                 								<table class="table" style="font-size: 13px;">
																	<%=MyUtility.generateHTML(patFaciesList, new HashMap<Integer, String>(), "infoId", patCurInfoDTO.patInfoId, patCurInfoDTO)%>
										                         </table>
									                         </div><!--/./form-group--> 
                           								 </div>
                           							 </div>
