                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            <tr>
                                                                ...
                                                                <td class="tableData2">
                                                                    <input type="checkbox" name="exposureTo" value="<%=key%>" <%if(patCurInfoDTO.patExposureToId.contains(key)==true){%>checked="checked"<%}%>> <%=patExposureToList.get(key).getName()%>
                                                                </td>
                                                                <%}%>
                                                            </tr>
                                                        </table>
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" name="habitsId" value="4" <%if(patCurInfoDTO.patHabitsId.contains(4)==true){%>checked="checked"<%}%>> <%=patHabitsList.get(4).getName()%>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" name="habitsId" value="5" <%if(patCurInfoDTO.patHabitsId.contains(5)==true){%>checked="checked"<%}%>> <%=patHabitsList.get(5).getName()%>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" name="habitsId" value="6" <%if(patCurInfoDTO.patHabitsId.contains(6)==true){%>checked="checked"<%}%>> <%=patHabitsList.get(6).getName()%>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" name="habitsId" value="7" <%if(patCurInfoDTO.patHabitsId.contains(7)==true){%>checked="checked"<%}%>> <%=patHabitsList.get(7).getName()%>
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            ...
                                                            <tr>
                                                                <td class="tableData2">
                                                                    <input type="checkbox" name="menstrualHistoryId" value="<%=key%>" <%if(patCurInfoDTO.patMenstrualHistoryId.contains(key)==true){%>checked="checked"<%}%>> <%=patMenstrualHistoryList.get(key).getName()%>
                                                                </td>
                                                            </tr>
                                                            <%}%>
                                                        </table>
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            ...
                                                            <tr>
                                                                <td class="tableData2">
                                                                    <input type="checkbox" name="obstetricalHistoryId" value="<%=key%>" <%if(patCurInfoDTO.patObstetricalHistoryId.contains(key)==true){%>checked="checked"<%}%>> <%=patObstetricalHistoryList.get(key).getName()%>
                                                                </td>
                                                            </tr>
                                                            <%}%>
                                                        </table>
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <%}
                                                                                count++;%>
                                                                            <td class="tableData2">
                                                                                <input type="checkbox" name="relevantDiseaseHistoryId" value="<%=key%>" <%if(patCurInfoDTO.patRelevantDiseaseHistoryId.contains(key)==true){%>checked="checked"<%}%>> <%=patFamilyRelevantDiseaseHistoryList.get(key).getName()%>
                                                                            </td>
                                                                            <%}%>
                                                                        </tr>
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            ...
                                                            <tr>
                                                                <td class="tableData2">
                                                                    <input type="checkbox" name="immunizationHistoryId" value="<%=key%>" <%if(patCurInfoDTO.patImmunizationHistoryId.contains(key)==true){%>checked="checked"<%}%>> <%=patHistoryOfImmunizationList.get(key).getName()%>
                                                                    <%if(key==41){%>
