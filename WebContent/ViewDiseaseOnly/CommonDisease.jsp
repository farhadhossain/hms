...
HashMap<Integer, String> disSymptomList = disServ.getDiseaseDetailsByDisIDAndDisType(key, MyConfig.diseaseSymptom);
...
HashMap<Integer, String> disAuscultationList = disServ.getDiseaseDetailsByDisIDAndDisType(key, MyConfig.diseaseAuscultation);
...
HashMap<Integer, String> disOthersList = disServ.getDiseaseDetailsByDisIDAndDisType(key, MyConfig.diseaseOthers);
HashMap<Integer, String> disOthersParentByChild = disServ.getParentByChildWithDisIDAndDisType(key, MyConfig.diseaseOthers);

HashMap<Integer, String> disPerticipatingFactorList = disServ.getDiseaseDetailsByDisIDAndDisType(key, MyConfig.diseasePerticipatingFactor);
