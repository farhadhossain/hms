										    		...
										    		<%if(editAndView==true || (editAndView==false && patCurDisDTO.patHisId.isEmpty()==false)){%>
											    		<div class="table-responsive">
															<table class="table" style="font-size: 13px;">
																<%if(editAndView==true || (editAndView==false && patCurDisDTO.getOmLocation()!=null && patCurDisDTO.getOmLocation().length()>0)){%>
																	<tr><td style="border: none;" class="tableData2">Location <input type="text" name="omLocation" value="<%=patCurDisDTO.getOmLocation()%>"></td></tr>
																<%}%>
																
																<%if(editAndView==true || (editAndView==false && patCurDisDTO.getOmDuration()!=null && patCurDisDTO.getOmDuration().length()>0)){%>
																	<tr><td style="border: none;" class="tableData2">Duration <input type="text" name="omDuration" value="<%=patCurDisDTO.getOmDuration()%>"></td></tr>
																<%}%>
																
																<%if(editAndView==true || (editAndView==false && patCurDisDTO.getOmTimeframe()!=null && patCurDisDTO.getOmTimeframe().length()>0)){%>
																...
																<%if(editAndView==true || (editAndView==false && patCurDisDTO.getOmIntensity()!=null && patCurDisDTO.getOmIntensity().length()>0)){%>
																...
																<%if(editAndView==true || (editAndView==false && patCurDisDTO.getOmMechanism()!=null && patCurDisDTO.getOmMechanism().length()>0)){%>
										    		...
										    		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
										    			<div class="panel panel-default">
		                            						...
		                            						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
		                              							<div class="panel-body">
																	<%if(editAndView==true || (editAndView==false && patCurDisDTO.patPalpId.isEmpty()==false)){%>
																		<div class="table-responsive">
																			<table class="table" style="font-size: 13px;">
