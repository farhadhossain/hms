...
<%
    ...
    String actionNameFollowUp="/NewFindingsRenal";
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Renal <%if(editAndView==false){%><a href="<%=OthersInfo.getPageNameByID(Integer.parseInt(userID), Integer.parseInt(diseaseID))+"&typeID=1"%>"> ( Edit )</a><%}%></h5>
                        </div><!--/./ibox-title-->
                        <div class="ibox-content">
                            <html:form action="/PatientRenal">
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-responsive">
                                                        <table class="table" style="font-size: 13px;">
                                                            <%=utility.MyUtility.generateHTML(disHistoryList, disHistoryParentByChild, "historyId", patCurDisDTO.patHisId, patCurDisDTO, editAndView)%>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
