...
<html>
    ...
    <div class="panel-body">
        <section class="text-center">
            ...
            <h2>Log Book</h2>
            <h4>
                 <%=userDTO.getProgram()%> Training Program Phase- <%=userDTO.getProgram()%><br/>
                For<br/>
        ...
        <section style="margin-top:20px;">
            ...
            <h4><strong>Name of <%=userDTO.getProgram().equals("null")?"[Student's designation not mentioned]":userDTO.getProgram()%> Student:</strong> <%=userDTO.getEmployeeName()%></h4>
            <table>
                <tbody>
                <tr>
                    <td> <strong>Resident ID:</strong> <%=userDTO.getStudentId()%> &nbsp;</td>
                    <td> <strong>Phase:</strong> <%=userDTO.getPhase()%> &nbsp;</td>
                    <td> <strong>Block:</strong> <%=userDTO.getBlock()%> </td>
                </tr>
                <tr>
        ...
        <div class="panel panel-default" style="margin-top:20px;<%if(diagnosisPatLists.size()==0){%>display:none;<%}%>">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                       ...
                       <%
                           ...
                           PrescriptionDTO presDTO = presDAO.getPrescriptionByPatientId(key, 0);
                           i++;
                                ...
                                <td>
                                    <table class="diagnosis" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><%= StringUtils.isEmpty(presDTO.getDiagonosis())?"":new JSONArray(presDTO.getDiagonosis()).getJSONObject(0).getString("disease")%></td>
                                        </tr>
        ...
        <div class="panel panel-default" style="margin-top:20px;<%if(minorOtPatLists.size()==0){%>display:none;<%}%>">
        ...
        <div class="panel panel-default" style="margin-top:20px;<%if(majorOtPatLists.size()==0){%>display:none;<%}%>">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="my_disease">
                                <table>
                                <%
                                    int currentVisitId = new VisitDAO().getCurrentVisitId(dto.getPatientId());
                                ...
                                <%Iterator<Integer> it = visitDTO.diseaseTypeHash.iterator();
                                    while(it.hasNext()) {
                                        ...
                                        DiseaseDTO patCurDisDTO = disServ.getDiseaseInfo(dto.getPatientId(), currentVisitId, diseaseTypeKey);
